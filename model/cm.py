...
log_path = '/home/lhy/storage/code/promptsmell/results/cm.log'
data_path = '/home/lhy/storage/code/promptsmell/data/LM-LPL.json'
model_name = 'roberta'
...
# name = data_path.split('.')[0] + '.png'
print(f'------------ {data_path} ------------')
file_path = data_path
png_path = os.path.join(save_path, 'cm.png')
...
test_accuracy, test_weighted_precision, test_weighted_recall, test_weighted_f1, avg_latency_ms, throughput_sps = test_val_model(
    promptModel, testdata_loader, device, best_val_f1=-1, types='test', is_save_cm=True, save_path=png_path)